...
function procesarPendientes() {
  ...
  const promesas = pendientes.map(op => {
    if (op.tipo === "POST") {
      return fetch("https://c4a74189feb5.ngrok-free.app/tareas", {
        method: "POST",
    ...
    if (op.tipo === "DELETE") {
      ...
      return fetch(`https://c4a74189feb5.ngrok-free.app/tareas/${idReal}`, 
        { method: "DELETE",
...
function cargarTareas() {
  ...
  fetch("https://c4a74189feb5.ngrok-free.app/tareas", { headers: { "ngrok-skip-browser-warning": "true","Content-Type":"application/json" } })
    .then(res => res.json())
    .then(arrTareas => {
      localStorage.setItem("tareas", JSON.stringify(arrTareas));
      mostrarTareas({ arrTareas, mostrarModalConfirmEdit, mostrarModalConfirmDelete });
...
function agregarTarea(descripcion) {
  ...
  fetch("https://c4a74189feb5.ngrok-free.app/tareas", {
    method: "POST",
...
function eliminarTarea(id) {
  fetch(`https://c4a74189feb5.ngrok-free.app/tareas/${id}`, { method: "DELETE", headers: { "Content-Type": "application/json", "ngrok-skip-browser-warning": "true" } })
    .then(() => cargarTareas());
}

function editarTarea(id, descripcion) {
  fetch(`https://c4a74189feb5.ngrok-free.app/tareas/${id}`, {
    method: "PUT",
